...
export default function CustomerOnboarding() {
  ...
  const [data, setData] = useState({
    ...
    email: "",
    password: "",
    neighbourhood: "kanata", // pre-selected, only option
    agreedToTerms: false,
  });

  // Brand tokens — keeping consistent with prior screens
            ...
            >
              ...
              {step === 0 && (
                ...
                >
                  <span
                    className="font-body"
                    style={{ fontSize: 12, color: inkSoft }}
                  >
                    Already a member?{" "}
                  </span>
                  <button
...
function WelcomeStep({ tokens }) {
  return (
    <div style={{ padding: "20px 24px 0" }}>
      ...
      {/* What's this — group buy explainer */}
      <div
        style={{
...
function AccountStep({ data, update, showPassword, setShowPassword, tokens }) {
  ...
  return (
    <div style={{ padding: "20px 24px 0" }}>
      ...
      >
        ...
        >
          I agree to the{" "}
          <span style={{ color: tokens.royalBlue, fontWeight: 600 }}>
            Terms
          </span>{" "}
          and{" "}
          <span style={{ color: tokens.royalBlue, fontWeight: 600 }}>
      ...
      >
        <ShieldCheck
          size={14}
          strokeWidth={2}
          style={{ color: tokens.success, flexShrink: 0 }}
        />
        <span
          className="font-body"
          style={{
...
function NeighbourhoodStep({ data, update, tokens }) {
  return (
    <div style={{ padding: "20px 24px 0" }}>
      <div
        className="font-body"
        ...
        style={{
          ...
          background:
            data.neighbourhood === "kanata"
              ...
              : tokens.kraftLight,
          color:
            data.neighbourhood === "kanata" ? tokens.kraftLight : tokens.ink,
          border:
            data.neighbourhood === "kanata"
              ? "none"
    ...
    <div style={{ padding: "20px 24px 0" }}>
      ...
      >
        <Mail
          size={14}
          strokeWidth={2.2}
          style={{ color: tokens.royalBlue, flexShrink: 0 }}
        />
        <div style={{ flex: 1 }}>
          <div
            className="font-body"
      ...
      >
        {[
          ...
          const progressPct = Math.min(100, (deal.joined / deal.min) * 100);
