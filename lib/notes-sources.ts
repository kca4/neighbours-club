 ...
 * sourceId is the raw ingest key (e.g. "cbc-ottawa"); sourcePublisher is the
 * string shown to users and stored in attribution fields (e.g. "CBC Ottawa").
 *
