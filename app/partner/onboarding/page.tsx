...
interface PartnerFormData {
  ...
  menuMethod: "bulk" | "manual" | null;
  items: MenuItem[];
  bulkText: string;
  photosSkipped: boolean;
  bankConnected: boolean;
  callSlot: number | null;
}
...
export default function PartnerOnboardingFlow() {
  ...
  const update = (patch: Partial<PartnerFormData>) => setData((d) => ({ ...d, ...patch }));
  ...
  return (
    <div>
      ...
      >
        ...
        &mdash; you can pause and come back anytime.
      </p>
        ...
        {[
          ...
          >
            <Check
              size={14}
              strokeWidth={2.5}
              style={{ color: tokens.royalBlue, marginTop: 2, flexShrink: 0 }}
            />
            <span
              className="font-body"
              style={{ fontSize: 13, color: tokens.ink, lineHeight: 1.45 }}
            >
              {item}
            </span>
          </div>
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          ...
          <p
            className="font-display"
            style={{ fontSize: 15, fontStyle: "italic", fontWeight: 500, lineHeight: 1.4, margin: 0 }}
          >
...
interface StepProps {
  ...
  update: (patch: Partial<PartnerFormData>) => void;
  tokens: Tokens;
}

function AboutStep({ data, update, tokens }: StepProps) {
  return (
    <div>
      <StepHeader
...
function OwnerStep({ data, update, tokens }: StepProps) {
  return (
    <div>
      <StepHeader
        eyebrow="Step 2 \u00b7 You"
...
function HoursStep({ data, update, tokens }: StepProps) {
  const days = [
    { key: "mon", label: "Mon" },
    { key: "tue", label: "Tue" },
    { key: "wed", label: "Wed" },
          ...
          return (
            <div
              ...
              style={{
                ...
                padding: "10px 14px",
                gap: 12,
                borderBottom: i < days.length - 1 ? `1px solid ${tokens.kraftDark}30` : "none",
              }}
            >
              <button
              ...
              {h.open ? (
                <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  />
                  <span className="font-body" style={{ color: tokens.inkSoft, fontSize: 12 }}>
                    to
                  </span>
                  <input
                    className="input-clean"
                ...
                <span
                  className="font-body"
                  style={{ flex: 1, color: tokens.inkSoft, fontSize: 13, fontStyle: "italic" }}
                >
                  Closed
                </span>
              )}
...
function MenuStep({ data, update, tokens }: StepProps) {
  if (!data.menuMethod) {
    return (
      <div>
        <StepHeader
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <div
              className="font-display"
              style={{ fontSize: 16, fontWeight: 600, color: tokens.ink, lineHeight: 1.2, marginBottom: 3 }}
            >
              Bulk upload
              <span
                className="font-body"
            ...
            <p
              className="font-body"
              style={{ fontSize: 12, color: tokens.inkSoft, margin: 0, lineHeight: 1.4 }}
            >
              Paste menu text, upload a PDF, or take a photo of your menu.
              We&apos;ll do the typing.
            </p>
          </div>
          <ChevronRight size={18} strokeWidth={2} style={{ color: tokens.inkSoft, flexShrink: 0 }} />
        </button>
  ...
  if (data.menuMethod === "bulk") {
    return (
      <div>
        ...
        >
          &mdash; or paste menu text below &mdash;
        </div>
        ...
        <textarea
          ...
          className="input-clean"
          style={{ minHeight: 160, fontFamily: "'Inter Tight', sans-serif", resize: "vertical" }}
        />
  ...
  return (
    <div>
      ...
      <button
        onClick={() => update({ items: [...data.items, { name: "", price: "", desc: "" }] })}
        style={{
          width: "100%",
          background: "transparent",
...
function PhotosStep({ data, update, tokens }: StepProps) {
  return (
    <div>
      <StepHeader
      ...
      >
        ...
        <div>
          <div
            className="font-display"
            style={{ fontSize: 15, fontWeight: 600, fontStyle: "italic", lineHeight: 1.2 }}
          >
            Items with photos sell ~2&times; more
          </div>
          <p className="font-body" style={{ fontSize: 11, opacity: 0.75, margin: 0, marginTop: 2 }}>
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        >
          ...
          >
            &middot; top of your spotlight page
          </span>
        </div>
        <button
          style={{
        ...
        >
          ...
          <span className="font-body" style={{ fontSize: 11, color: tokens.inkSoft }}>
            JPG or PNG, 1200&times;800 ideal
          </span>
        </button>
      </div>
      ...
      <button
        ...
        style={{
          ...
          border: `1px solid ${data.photosSkipped ? tokens.warning : tokens.kraftDark}80`,
          borderRadius: 12,
          padding: "12px 14px",
          cursor: "pointer",
          display: "flex",
      ...
      >
        <div
          style={{
            ...
            border: data.photosSkipped ? "none" : `1.5px solid ${tokens.kraftDark}`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            color: tokens.kraftLight,
        ...
        <div style={{ flex: 1, textAlign: "left" }}>
          <div className="font-body" style={{ fontSize: 13, fontWeight: 600, color: tokens.ink }}>
            I&apos;ll add photos later
          </div>
          <div className="font-body" style={{ fontSize: 11, color: tokens.inkSoft, marginTop: 2 }}>
...
function PayoutsStep({ data, update, tokens }: StepProps) {
  return (
    <div>
      <StepHeader
      ...
      >
        ...
        <div style={{ flex: 1, textAlign: "left" }}>
          ...
          <div className="font-body" style={{ fontSize: 11, opacity: 0.85, marginTop: 2 }}>
            {data.bankConnected ? "RBC \u00b7 \u25cf\u25cf\u25cf\u25cf4321" : "Secured by Stripe \u00b7 1 minute"}
          </div>
        </div>
          ...
          {[
            ...
            <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
              ...
              <div>
                <div
                  className="font-display"
                  style={{ fontSize: 13, fontWeight: 600, color: tokens.ink, lineHeight: 1.2 }}
                >
                  {row.label}
                </div>
                <div className="font-body" style={{ fontSize: 11, color: tokens.inkSoft, marginTop: 2 }}>
...
function CallStep({ data, update, tokens }: StepProps) {
  const slots = [
  ...
  return (
    <div>
          ...
          return (
            <button
              ...
              style={{
                ...
                border: selected ? "none" : `1px solid ${tokens.kraftDark}60`,
                borderRadius: 12,
                padding: "12px 14px",
                cursor: "pointer",
                display: "flex",
            ...
            >
              <div
                style={{
                  ...
                  height: 44,
                  borderRadius: 10,
                  background: selected ? tokens.kraftLight + "20" : tokens.kraft,
                  display: "flex",
                  flexDirection: "column",
                  alignItems: "center",
                  justifyContent: "center",
              ...
              >
                ...
                <span
                  className="font-display"
                  style={{ fontSize: 17, fontWeight: 700, fontStyle: "italic", lineHeight: 1 }}
                >
                  {slot.date.split(" ")[2]}
                </span>
              </div>
              <div style={{ flex: 1 }}>
                ...
                >
                  30 min &middot; video or phone &mdash; you pick
                </div>
              </div>
      ...
      >
        Don&apos;t see a good time? See more options &rarr;
      </button>
    </div>
  );
}

function DoneStep({ data, tokens }: { data: PartnerFormData; tokens: Tokens }) {
  return (
    <div>
      {/* Big check */}
      <div
      ...
      <p
        className="font-body"
        style={{ fontSize: 14, lineHeight: 1.55, color: tokens.inkSoft, marginBottom: 28 }}
      >
        ...
        {[
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div
                className="font-body"
                style={{ fontSize: 11, color: tokens.inkSoft, lineHeight: 1.45 }}
              >
                {item.sub}
              </div>
            </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            <div
              ...
              style={{ fontSize: 15, fontWeight: 600, fontStyle: "italic", lineHeight: 1.2 }}
            >
              Alex &middot; Partner success
            </div>
            <div className="font-body" style={{ fontSize: 11, opacity: 0.75, marginTop: 2 }}>
              alex@neighbors.app &middot; (613) 555-0100
            </div>
          </div>
        </div>
      </div>
...
function StepHeader({ eyebrow, title, sub, tokens }: StepHeaderProps) {
  return (
    <div style={{ marginBottom: 24 }}>
      ...
      {sub && (
        <p
          className="font-body"
          style={{ fontSize: 13, color: tokens.inkSoft, lineHeight: 1.5, margin: 0 }}
        >
          {sub}
        </p>
      )}
...
function Field({ label, sub, children, tokens }: FieldProps) {
  return (
    <div style={{ marginBottom: 14 }}>
      <div
        className="font-body"
      ...
      {sub && (
        <div
          className="font-body"
          style={{ fontSize: 11, color: tokens.inkSoft, marginBottom: 6, lineHeight: 1.4 }}
        >
          {sub}
        </div>
      )}
...
function InfoCallout({ icon, title, text, tokens }: InfoCalloutProps) {
  return (
    <div
      style={{
    ...
    >
      <div style={{ color: tokens.royalBlue, marginTop: 1, flexShrink: 0 }}>{icon}</div>
      <div>
        <div
          className="font-body"
          style={{ fontSize: 12, fontWeight: 700, color: tokens.ink, marginBottom: 2 }}
        >
          {title}
        </div>
        <div className="font-body" style={{ fontSize: 11, color: tokens.inkSoft, lineHeight: 1.45 }}>
          {text}
        </div>
      </div>
    </div>
